...
The technical report (in Juypter Notebook) Corporate_Employee_Database_and_Technical_Report.ipynb file in the GitHub Corporate-Employees-Analysis repository.
